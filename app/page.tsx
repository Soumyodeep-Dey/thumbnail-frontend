...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-6 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      {/* Header */}
      ...
      <form
        ...
        className="glass-effect p-8 rounded-2xl w-full max-w-lg hover-lift"
      >
        <div className="mb-6">
